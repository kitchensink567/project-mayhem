package
{
   ...
   public class o20015 extends Sprite
   {
       
      
      public function o20015()
      {
         super();
      }
...
class o12957 extends o18442
{
   ...
   public static function getGradeCacheAssets(param1:int, param2:int) : Vector.<String>
   {
      ...
      var _loc5_:o1587 = o4519.o8116.o4235.o4248(8);
   ...
   public function o16955(param1:int, param2:int, param3:o18509, param4:int) : void
   {
      ...
      grade = param2;
      type = 8;
      var _loc9_:o1587 = o4519.o8116.o4235.o4248(8);
      ...
      o1589 = o11243;
      o4699 = 275;
      o3478 = o4519.o8116.o4550(_loc7_.o18823) * (1 - 0.1 + o4519.o8116.random.o10418(param1) * 2 * 0.1);
      o3843 = o3478;
      ...
      super.o19011(param1,_loc5_,_loc8_,param3,param4,9,false);
