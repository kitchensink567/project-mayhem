package
{
   ...
   public class o13066 extends o9743
   {
      ...
      public function o13066()
      {
         super();
      }
      
      public function o16384(param1:MovieClip, param2:Function, param3:Function, param4:o20516) : void
      {
         super.init(param1);
      ...
      {
         var _loc2_:MovieClip = o13287.getChildByName("progressContainer") as MovieClip;
         var _loc3_:TextField = _loc2_.getChildByName("lblProgress") as TextField;
         _loc3_.text = "+" + o16724.o10417(param1) + " Progress XP";
         o13287.gotoAndPlay(1);
         o13287.visible = true;
      }
      ...
      public function o11246(param1:int, param2:String, param3:String, param4:int, param5:int, param6:String, param7:String, param8:int, param9:Function, param10:String) : void
      {
         ...
         {
            o9659.text = "Upgrade for $" + o16724.o10417(param8);
         }
