package
{
   ...
   public class o18111 extends Sprite
   {
       
      
      public function o18111()
      {
         super();
      }
...
class o1929 extends o18442
{
    
   
   private var o2746:String;
   
   private var o18395:String;
   
   private var o19443:String;
   
   private var o9113:String;
   
   private var o5782:o72;
   ...
   public static function getGradeCacheAssets(param1:int, param2:int) : Vector.<String>
   {
      ...
      var _loc6_:o1587 = o4519.o8116.o4235.o4248(5);
      _loc5_ = param1;
      while(_loc5_ <= param2)
      {
   ...
   public function o16955(param1:int, param2:int, param3:o18509, param4:int) : void
   {
      ...
      type = 5;
      grade = param2;
      var _loc8_:o1587 = o4519.o8116.o4235.o4248(5);
      ...
      o2746 = o4519.o8116.o5830.o9009(_loc6_.o853);
      o18395 = o4519.o8116.o5830.o9009(_loc6_.o12311);
      o885 = o18395;
      ...
      o19443 = o4519.o8116.o5830.o9009(_loc8_.o6568);
      o9296 = o19443;
      o8193 = _loc8_.o8193;
      o9747 = _loc8_.o5949;
      o1918 = _loc6_.o1918;
      ...
      o1051.o9310(this,0.05,o12044);
   }
   
   private function o12044() : void
   {
      o5782 = o72(o4519.o8116.o2996.o2998(o72,[this,grade]));
      o1051.o4767(this,0.0333333333333333,o13587);
   }
   
   private function o13587() : void
   {
      if(o6955 || o8289())
      {
         return;
      }
      o5782.body.o16687(o6691.rotation);
      o5782.body.o8564(body.position.x,body.position.y);
   }
   ...
   override protected function o1342(param1:Boolean, param2:o4016) : void
   {
      if(o5782 && o5782.body)
      {
         o5782.body.o15838(o8723.o20122);
      }
   ...
   private function o13574() : void
   {
      ...
      o4519.o8116.o4812.o14142.o1524.play(0.75,0,0,false,_loc1_.o10088(),0,9);
   }
}
