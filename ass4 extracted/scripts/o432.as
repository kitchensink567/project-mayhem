package
{
   ...
   public class o432 extends Sprite
   {
       
      
      public function o432()
      {
         super();
      }
...
class o17405 extends o7848
{
   ...
   public function o16955(param1:int, param2:Number, param3:Number, param4:Number, param5:o7848) : void
   {
      this.o5725 = param4;
      o3 = 2;
      this.o1432 = param5;
      ...
      o16166.o10589("assets.enemies.boss5Zombie.attack.fire.Partical");
   ...
   private function o8131() : void
   {
      ...
      {
         _loc1_ = _loc2_.o14145(o15710[_loc2_]);
         if(_loc1_ && _loc1_.o6193 == -1)
         {
            _loc2_.o977(o15710[_loc2_],3);
         }
      }
